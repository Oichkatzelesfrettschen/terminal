...
namespace winrt::Microsoft::Terminal::Settings::Editor::implementation
{
    ...
    public:
        ...
        PERMANENT_OBSERVABLE_PROJECTED_SETTING(_settings.GlobalSettings(), EnableDirectStorageCache);
    ...
    struct Compatibility : public HasScrollViewer<Compatibility>, CompatibilityT<Compatibility>
    {
        ...
        void ClearDirectStorageCacheButton_Click(const Windows::Foundation::IInspectable& sender, const Windows::UI::Xaml::RoutedEventArgs& e);
